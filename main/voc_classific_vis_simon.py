...
def spectrogram(mic, energy_filt, fem_edges, male_edges, both_edges, top_plot_edges,
    ...
    fig.savefig(f'../plots/{rec_id}_vocalizaiton.png')



#import the filtered data list csv
filt_data_files = pd.read_csv('/run/media/loaloa/Samsung_T5/filt_birdsong_data/filt_data_files_MinAmp0.05_PadSec0.50.csv', index_col='rec_id')
...
# male_x, _, _, _ = plt.specgram(S_trivial_m_acc, Fs=24000)
# male_y, _, _, _ = plt.specgram(S_trivial_m_mic, Fs=24000)
# ...